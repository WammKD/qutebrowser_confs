...
c.aliases = { 'q'              : 'quit',
              'wq'             : 'quit --save',
              'w'              : 'session-save',
              'Dictionary'     : 'open http://dictionary.com/browse/',
...
## Type: Dict
# c.bindings.key_mappings = {'<Ctrl-6>': '<Ctrl-^>', '<Shift-Return>': '<Return>', '<Ctrl-J>': '<Return>', '<Ctrl-Enter>': '<Ctrl-Return>', '<Ctrl-M>': '<Return>', '<Shift-Enter>': '<Return>', '<Ctrl-[>': '<Escape>', '<Enter>': '<Return>'}
...
## Type: QssColor
## Default: green
c.colors.hints.match.fg = '#000088'
...
config.set('content.javascript.enabled', False, '*://*.bostonglobe.com/*')
...
c.content.user_stylesheets = ["~/.config/qutebrowser/stylesheets/duckduckgo.css"]
...
c.editor.command = ['emacs', '+{line}:{column0}', '{file}']
# c.editor.command = ['gnome-terminal', '--command="emacs -nw +{line}:{column0} {file}"']
...
config.bind('FL', 'hint all tab-bg')
...
config.bind('cp', 'hint links yank')
...
config.bind('i',        'scroll-page 0 -1')
# config.bind('<Ctrl-D>', 'scroll-page 0 0.5')
config.unbind('R')
config.bind('<Ctrl-Shift-r>',     'reload -f')
#config.bind('<Ctrl-f>',           'scroll-page 0 1')
config.bind('o',                  'scroll-page 0 1')
config.bind('<Ctrl-Shift-Alt-n>', 'open -w')
...
config.bind('<Ctrl-Shift-Alt-t>', 'open -t')
# config.bind('<Ctrl-Tab>', 'tab-focus last')
# config.bind('<Ctrl-U>', 'scroll-page 0 -0.5')
config.bind('<Ctrl-Shift-f>', 'enter-mode passthrough')
config.bind('<Ctrl-w>', 'tab-close')
# config.bind('<Ctrl-X>', 'navigate decrement')
# config.bind('<Ctrl-^>', 'tab-focus last')
config.bind('<Ctrl-Shift-h>', 'home')
# config.bind('<Ctrl-p>', 'tab-pin')
config.bind('<Ctrl-Shift-s>', 'stop')
...
config.unbind('D')
config.bind('FT', 'hint all tab')
config.bind('O', 'scroll-to-perc')
...
config.bind('<Alt-h>',            'open -b qute://history')
config.bind('<Ctrl-Shift-Alt-h>', 'open -w qute://history')
# config.bind('Sq', 'open qute://bookmarks')
config.bind('<Ctrl-b>',           'open -t qute://bookmarks')
config.bind('<Alt-b>',            'open -b qute://bookmarks')
config.bind('<Ctrl-Shift-Alt-b>', 'open -w qute://bookmarks')
# config.bind('Ss', 'open qute://settings')
config.bind('<Ctrl-PgDown>', 'tab-focus')
...
config.bind('dk', 'download-remove')
config.bind('do', 'download-open')
config.bind('dg', 'download-cancel')
...
config.bind('<Ctrl-Alt-o>', 'set-cmd-text -s :bookmark-load -t')
config.bind('<Alt-c>', 'tab-clone')
config.bind('<Alt-Up>', 'open -w {url:pretty} ;; tab-close')
# config.bind('gO', 'set-cmd-text :open -t -r {url:pretty}')
# config.bind('gU', 'navigate up -t')
# config.bind('g^', 'tab-focus 1')
# config.bind('ga', 'open -t')
# config.bind('gb', 'set-cmd-text -s :bookmark-load')
config.bind('<Ctrl-Shift-o>', 'set-cmd-text -s :bookmark-load')
...
config.bind('<Alt-Shift-D>', 'set-cmd-text :open {url:pretty}')
config.bind('<Ctrl-Shift-PgDown>', 'tab-move +')
# config.bind('gt', 'set-cmd-text -s :buffer')
# config.bind('gu', 'navigate up')
config.bind('j',        'scroll-px -40 0')
config.bind('<Left>',   'scroll-px -40 0')
config.bind('<Ctrl-i>', 'enter-mode insert')
config.bind('l',        'scroll-px 0 40')
config.bind('<Down>',   'scroll-px 0 40')
config.bind('k',        'scroll-px 0 -40')
config.bind('<Up>',     'scroll-px 0 -40')
config.bind(';',        'scroll-px 40 0')
config.bind('<Right>',  'scroll-px 40 0')
...
config.bind('<Alt-Shift-Left>',  'back -t')
config.bind('<Alt-Shift-Right>', 'forward -t')
# config.bind('u', 'undo')
# config.bind('v', 'enter-mode caret')
config.unbind('v')
# config.bind('wB', 'set-cmd-text -s :bookmark-load -w')
config.bind('<Ctrl-Shift-Alt-o>', 'set-cmd-text -s :bookmark-load -w')
# config.bind('wO', 'set-cmd-text :open -w {url:pretty}')
# config.bind('wP', 'open -w -- {primary}')
# config.bind('wb', 'set-cmd-text -s :quickmark-load -w')
config.unbind('wf')
config.bind('wfl', 'hint all window')
...
config.bind('<Alt-t>', 'set-cmd-text -s :open -b')
...
config.bind( 'dd',   'set-cmd-text -s :Dictionary')
...
config.bind('<Ctrl-?>', 'completion-item-del', mode='command')
...
config.bind('<Ctrl-Space>', 'leave-mode',  mode='command')
config.bind('<Ctrl-g>',     'leave-mode',  mode='command')
# config.bind('<Return>', 'command-accept', mode='command')
config.bind('<Ctrl-Delete>', 'completion-item-del', mode='command')
...
config.bind('<Ctrl-Space>', 'leave-mode',  mode='hint')
...
config.bind('<Ctrl-Space>',        'leave-mode',               mode='insert')
config.bind('<Ctrl-g>',            'leave-mode',               mode='insert')
config.bind('<Ctrl-PgUp>',         'tab-prev',                 mode='insert')
config.bind('<Ctrl-Shift-Tab>',    'tab-prev',                 mode='insert')
config.bind('<Ctrl-PgDown>',       'tab-focus',                mode='insert')
config.bind('<Ctrl-Tab>',          'tab-focus',                mode='insert')
...
config.bind('<Backspace>', 'rl-backward-delete-char', mode='prompt')
...
config.bind('<Ctrl-Space>', 'leave-mode',  mode='prompt')
...
config.bind('<Ctrl-Space>', 'leave-mode',  mode='register')
